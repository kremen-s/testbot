...
var token = '157513816:AAGXrZfyp6isZzv4GQsKYajhEknwT20-W3w';
...
/*bot.on('document', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	var messageFileID = msg.document.file_id;
	//bot.sendMessage (messageChatId, 'dat dok!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {documents_count_total: 1}});
	...
	//bot.sendMessage(messageChatId, messageFileID, stndrt_opts)
});
...
bot.on('audio', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat odio!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {photos_count_total: 1}});
											//bot.sendMessage (messageChatId,'плюсанули');
											});
									} else if (result===0) {
											//магия
...
bot.on('photo', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat pic!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
...
bot.on('location', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat loka!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {locations_count_total: 1}});
											//bot.sendMessage (messageChatId,'плюсанули');
											});
									} else if (result===0) {
											//магия
...
bot.on('voice', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat vos!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {voices_count_total: 1}});
											//bot.sendMessage (messageChatId,'плюсанули');
											});
									} else if (result===0) {
											//магия
...
bot.on('video', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat vid!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {videos_count_total: 1}});
											//bot.sendMessage (messageChatId,'плюсанули');
											});
									} else if (result===0) {
											//магия
...
bot.on('sticker', function (msg) {
	...
	var messageUserLName = msg.from.last_name;
	var iscommand = msg.entities;
	//bot.sendMessage (messageChatId, 'dat sticka!');
	//bot.sendMessage (messageChatId, 'uid: '+messageUserId);
			MongoClient.connect("mongodb://localhost:27017/exampleDb", function(err, db) {
			  if(!err) {
				//console.log('Yay, connected!');
								...
								//bot.sendMessage (messageChatId,'Countd uid:'+result);	
									if (result===1){
										//bot.sendMessage (messageChatId,'Уже есть '+result);
											...
											var collection = db.collection('usersTM');
											//магия
											collection.findOneAndUpdate({uid: messageUserId}, {$set: {username: messageUsr, first_name: messageUserFName, last_name: messageUserLName},$inc: {stckrs_count_total: 1}});
											//bot.sendMessage (messageChatId,'плюсанули');
											});
									} else if (result===0) {
											//магия
